...
CELERY_TASK_ACKS_LATE = os.environ.get('CELERY_TASK_ACKS_LATE', False) == 'True',
CELERY_WORKER_PREFETCH_MULTIPLIER = os.environ.get('CELERY_WORKER_PREFETCH_MULTIPLIER')
